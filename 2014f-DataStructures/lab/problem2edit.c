...
/* Takes a float as a parameter and type-casts it into a int, which is then
...
int getCents(float m) {
    ...
    // for clarity, the above line could be expaned as such:
    // float a = (m - getDollas(m)) * 100; // subtract dollars from total
    // int b = (int)a;                     // typecast float a to int
    // return b;                           // return int value
}
